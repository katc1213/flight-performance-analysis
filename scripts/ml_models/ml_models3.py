...
#   1. Added dep_del15 to features (strongest single predictor)
#   2. Added dest_enc to features
#   3. Added is_weekend + dep_period interaction features
#   4. Added target encoding for origin/dest/carrier (replaces raw LabelEncoder)
#   5. Tuned Random Forest (200 trees, depth 20, all cores)
#   6. Added XGBoost model (typically best AUC on tabular data)
#   7. Added final 3-model comparison chart
# =============================================================================
...
FEATURES_BASE = [
    "dep_del15",      # ← KEY ADDITION: departure delay is the strongest signal
    "month",
    "day_of_week",
    "is_weekend",     # new
    "dep_hour",
...
#
# 2. dep_del15: this is the strongest feature. It is NOT data leakage —
#    a departure delay has already occurred before arrival. It is a known
#    input at prediction time for any post-departure use case.
#
